                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("MegaByteCoin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a MegaByteCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and MGB:URIs)"));
...
//AAAA LimxDev Coinmix Tab	
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About MegaByteCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about MegaByteCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for MegaByteCoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your MegaByteCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified MegaByteCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a MGB:URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the MegaByteCoin Core help message to get a list with possible MegaByteCoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("MegaByteCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to MegaByteCoin network", "", count));
}
...
{
    QString strTitle = tr("MegaByteCoin"); // default title
