...
void Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("MegaByteCoin Core"),
     ...
     * override -datadir in the megabytecoin.conf file in the default data directory
     * (to be consistent with megabytecoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
