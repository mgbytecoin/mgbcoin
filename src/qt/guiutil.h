...
/** Utility functions used by the MegaByteCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render MegaByteCoin addresses in monospace font
...
// Parse "MGB:" URI into recipient object, return true on successful parsing
