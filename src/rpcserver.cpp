...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop MegaByteCoin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "MegaByteCoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* MegaByteCoin features */
        {"megabytecoin", "masternode", &masternode, true, true, false},
        {"megabytecoin", "masternodelist", &masternodelist, true, true, false},
        {"megabytecoin", "mnbudget", &mnbudget, true, true, false},
        {"megabytecoin", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"megabytecoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"megabytecoin", "mnsync", &mnsync, true, true, false},
        {"megabytecoin", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"megabytecoin", "Darksend", &Darksend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use megabytecoind, or the -server option to megabytecoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> megabytecoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:19663/\n";
}
