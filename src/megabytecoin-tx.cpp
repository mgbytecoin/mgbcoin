...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("MegaByteCoin Core megabytecoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  megabytecoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded MegaByteCoin transaction") + "\n" +
                               "  megabytecoin-tx [options] -create [commands]   " + _("Create hex-encoded MegaByteCoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded MegaByteCoin transaction
