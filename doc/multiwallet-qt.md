...
In order to support loading of multiple wallets in megabytecoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is megabytecoin.cpp.
...
Changes to megabytecoin.cpp
-------------------

megabytecoin.cpp is the entry point into megabytecoin-qt, and as such, will require some minor modifications to provide hooks for
